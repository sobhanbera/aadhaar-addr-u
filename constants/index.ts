...
export const ACTUAL_STATES_ARRAY = [
    'Andhra Pradesh',
    'Arunachal Pradesh',
    'Assam',
    'Bihar',
...
export const EVERY_DISTRICT_ARRAY: {
    [key: string]: string[];
} = {
    'Andaman and Nicobar Islands': [
        'Nicobar',
...
export const RANDOM_STATE_NAME =
    shuffleArray(STATES_ARRAY)[Math.floor(Math.random() * STATES_ARRAY.length)];

export const RANDOM_DISTRICT_NAME =
    shuffleArray(DISTRICTS_ARRAY)[
        Math.floor(Math.random() * DISTRICTS_ARRAY.length)
    ];
